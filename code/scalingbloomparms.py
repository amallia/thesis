...
class TexOutput:
    def __init__(self):
        print(r"% Generated by scalingbloomparms.py")
        print(r"\begin{tabular}{ r | c c r r | c c r r }")
        print(r"    \hline")
        print(r"    \rowcolor{blue!20}            & \multicolumn{4}{c}{Filter parms} & \multicolumn{4}{c}{Chain totals} \\")
        print(r"    \rowcolor{blue!20} \# filters & $K$ & $E$ & $M$ & $N$            & $K$ & $E$ & $M$ & $N$ \\")
        print(r"    \hline")
        self.row = 0
    def printline(self, *args):
        args = list(args)
