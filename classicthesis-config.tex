...
\newcommand{\myTitle}{Aggiunta dei filtri di Bloom al database NoSQL Redis\xspace}
\newcommand{\mySubtitle}{}
\newcommand{\myEnglishTitle}{Adding Bloom filters to the NoSQL Database Redis\xspace}
