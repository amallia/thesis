...
\begin{figure}
	...
	\begin{subfigure}[t]{280pt}
	\centering\includegraphics[width=280pt]{bloom_card_error_2h}
	\subcaption{M=8192, K=2}
	\end{subfigure}

	\begin{subfigure}[t]{280pt}
	\centering\includegraphics[width=280pt]{bloom_card_error_3h}
...
\begin{figure}
	...
	\begin{subfigure}[t]{280pt}
	\centering\includegraphics[width=280pt]{bloom_parms_1}
	\subcaption{Numero di elementi in base alla probabilità attesa}
	\end{subfigure}

	\begin{subfigure}[t]{280pt}
	\centering\includegraphics[width=280pt]{bloom_parms_2}
