...
l'implementazione del filtro di Bloom. Si veda \ref{sec:patchexplain} per una
descrizione dettagliata di questo codice.

\sourcecode[language=C,escapeinside={@}{@}]{code/bloom.h}
\sourcecode[language=C,escapeinside={@}{@}]{code/bloom.c}
