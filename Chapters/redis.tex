...
\begin{figure}
	...
	\caption{Diagramma di sequenza che mostra l'uso del \emph{pipelining} per diminuire
		il tempo totale d'esecuzione di 3 comandi}
\end{figure}
...
\fnhref{https://github.com/andymccurdy/redis-py/blob/8a186ebd9cecf466624803bdf215030158c7c776/redis/connection.py\#L517}{sorgenti della libreria \texttt{redis-py}}.
