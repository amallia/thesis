...
L'algoritmo (descritto in \autoref{alg:murmurhash2}) gode di una buona popolarità poiché unisce una
...
\Procedure{MurMurHash2}{$msg$, $seed$}
	\State $m \gets \mathtt{0x5bd1e995}$ \Comment{Costante moltiplicativa suggerita}
...
\href{https://github.com/andymccurdy/redis-py/blob/8a186ebd9cecf466624803bdf215030158c7c776/redis/connection.py\#L517}{sorgenti della libreria \texttt{redis-py}}.
...
\href{https://www.gnu.org/software/libc/manual/html_node/Waiting-for-I_002fO.html}{\texttt{select}},
\href{https://linux.die.net/man/4/epoll}{\texttt{epoll}} o 
\href{https://www.freebsd.org/cgi/man.cgi?query=kqueue&sektion=2}{\texttt{kqueue}}.
