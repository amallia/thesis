...
programmazione asincrona e accesso I/O non bloccante, appoggiandosi a primitive quali ``select'',
``epoll'' o ``kqueue''.
...
lock quale per esempio un ``mutex'' implementato dalla libreria ``pthread'' avrebbe un impatto non
