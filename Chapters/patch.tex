...
\begin{itemize}
	...
	il filtro possa occupare \SI{1}{\mebi\byte} di RAM alla creazione.
...
codice sorgente di Redis, e poiché l'output è a \SI{64}{\bit}, si considera la suddivisione in due
