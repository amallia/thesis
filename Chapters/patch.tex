...
\begin{commentedsource}[style=csource,caption=Strutture dati]
...
\begin{commentedsource}[style=csource,caption=Creazione e distruzione di un filtro]
...
\begin{commentedsource}[style=csource,caption=Aggiunta elemento ad un filtro]
